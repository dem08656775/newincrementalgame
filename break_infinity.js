    ...
    (function () {
      ...
      */
        ...
        if (isNaN(value)) {
          ...
          this.m =
            this.e === NUMBER_EXP_MIN
              ? (value * 10) / 1e-323
              : value / powerOf10(this.e); // SAFETY: Prevent weirdness.
        ...
        return ME(
          Math.round(
            1e14 * biggerDecimal.m +
              1e14 *
                smallerDecimal.m *
                powerOf10(smallerDecimal.e - biggerDecimal.e)
          ),
          biggerDecimal.e - 14
        );
      };
      ...
      Decimal.prototype.sqrt = function () {
        ...
        if (this.e % 2 !== 0) {
          return ME(
            Math.sqrt(this.m) * 3.16227766016838,
            Math.floor(this.e / 2)
          );
